                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="action-buttons">
                                        <a href="view_product.php?id=<?= $row['id'] ?>" class="action-btn view" title="View">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="adminproductedit.php?id=<?= $row['id'] ?>" class="action-btn edit" title="Edit">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <button onclick="deleteProduct(<?= $row['id'] ?>)" class="action-btn delete" title="Delete">
