...
// Ensure all stars (5 to 1) have a count, even if zero
for ($i = 5; $i >= 1; $i--) {
...
<head>
    ...
    <style>
        ...
        /* Just paste the entire CSS block from your original file here */
        * {
            margin: 0;
            padding: 0;
        ...
        /* Additional styles for product rating display */
        .product-rating {
            display: flex;
            align-items: center;
            gap: 15px;
        ...
        document.getElementById('submitReviewForm').addEventListener('submit', function (e) {
            ...
            .then(data => {
                ...
                if (data.success) {
                    ...
                    location.reload(); // <-- This line reloads the page after successful submission
                } else {
